...
#This one uses laplace smooting
        ...
        for i in range(len(l2)):
            ...
            for j in range(len(l2)):
                ...
                if l2[j] not in self.dict["<s>"][new_state]:
                    ...
                    self.dict_freq["<s>"][new_state][l2[j]] = 1
            ...
            for j in range(len(l2)):
                ...
                for k in range(len(l3)):
                    ...
                    if l3[k] == "</s>":
                        if l3[k] not in self.dict[curr_state]:
                            ...
                            if l3[k] not in self.dict[curr_state][l3[k]]:
                                ...
                                self.dict_freq[curr_state][l3[k]][l3[k]] = 1
                        continue
                    ...
                    if l3[k] not in self.dict[curr_state][new_state]:
                        ...
                        self.dict_freq[curr_state][new_state][l3[k]] = 1
